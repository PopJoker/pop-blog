      ...
      <section className="relative pt-20 pb-16 md:pt-32">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mt-10 flex flex-col items-center gap-6">
            ...
            <div
              onClick={handleCopy}
              className="group flex cursor-pointer items-center gap-2 text-xs text-gray-500 transition-colors hover:text-primary-500"
            >
              <span>或來信談談：</span>
              <span className="font-mono underline underline-offset-4">{copyLabel}</span>
              <svg className="h-3.5 w-3.5 opacity-50 group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
